...
export const CATALOG = [
  ...
  c('stair-climber', 'Stair Climber / StairMaster', 'Cardio Machine', ['Glutes', 'Quadriceps', 'Calves'], ['Hamstrings', 'Core'], 9, { distance: true }),
  ...
  c('elliptical', 'Elliptical Trainer', 'Cardio Machine', ['Quadriceps', 'Glutes', 'Hamstrings'], ['Chest', 'Back', 'Arms'], 7, { distance: true }),
  c('air-bike', 'Assault / Air Bike', 'Cardio Machine', ['Quadriceps', 'Calves', 'Anterior Deltoids'], ['Triceps', 'Core'], 10.5, { distance: true }),
  c('skierg', 'SkiErg Machine', 'Cardio Machine', ['Latissimus Dorsi', 'Triceps', 'Core'], ['Rectus Abdominis', 'Glutes'], 9, { distance: true }),
  c('jacobs-ladder', 'Jacobs Ladder Machine', 'Cardio Machine', ['Quadriceps', 'Calves', 'Core'], ['Glutes', 'Anterior Deltoids'], 11, { distance: true }),
